...
echo ""
echo -e "${CYAN}  Optional config (data/config.json):${NC}"
echo ""
echo "    Customer logo (sidebar branding for demos):"
echo "      \"customerLogo\": \"default.png\",      # File in public/logos/"
echo "      \"customerName\": \"AWS\",               # Alt text"
echo "      \"customerLogoBg\": \"dark\"              # dark=transparent, light=white bg"
echo ""
echo "    Admin access control (/accounts, /iam pages):"
echo "      \"adminEmails\": [\"admin@awsops.local\"]  # Empty array = all users allowed"
echo ""
